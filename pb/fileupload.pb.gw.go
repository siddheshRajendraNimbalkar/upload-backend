...
func request_FileUploadService_DownloadFile_0(ctx context.Context, marshaler runtime.Marshaler, client FileUploadServiceClient, req *http.Request, pathParams map[string]string) (FileUploadService_DownloadFileClient, runtime.ServerMetadata, error) {
	var (
...
func RegisterFileUploadServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FileUploadServiceClient) error {
	mux.Handle(http.MethodGet, pattern_FileUploadService_DownloadFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_FileUploadService_DownloadFile_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	})
	return nil
}
...
var (
	forward_FileUploadService_DownloadFile_0 = runtime.ForwardResponseStream
)
