...
const file_fileupload_proto_rawDesc = "" +
	...
	"\afile_id\x18\x01 \x01(\tR\x06fileId2\xf8\x02\n" +
	...
	"\x11GetUploadMetadata\x12\x16.pb.GetMetadataRequest\x1a\x12.pb.UploadMetadata\"&\x82\xd3\xe4\x93\x02 \x12\x1e/v1/uploads/{file_id}/metadataB8Z6github.com/siddheshRajendraNimbalkar/upload-backend/pbb\x06proto3"
...
var file_fileupload_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_fileupload_proto_depIdxs = []int32{
	...
	9, // 5: pb.FileUploadService.InitUpload:output_type -> pb.InitResponse
	3, // 6: pb.FileUploadService.UploadFile:output_type -> pb.UploadStatus
	5, // 7: pb.FileUploadService.GetUploadedChunks:output_type -> pb.GetChunksResponse
	2, // 8: pb.FileUploadService.DownloadFile:output_type -> pb.DownloadResponse
	7, // 9: pb.FileUploadService.GetUploadMetadata:output_type -> pb.UploadMetadata
